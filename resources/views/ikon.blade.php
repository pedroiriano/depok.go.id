...
@section('content')
<div class="jumbotron jumbotron-fluid banner" style="background-image: url({{ asset('img/karya_new_watermark/Umum_Keluarga_Khodok.png') }})">
</div>
    ...
    <div class="container">
        ...
        <div class="row py-5 justify-content-center">
           <div class="col-6 pb-5">
              <img src="{{ asset('img/sekilas-depok/7.jpg') }}" alt="" class="img-fluid">
           </div>
