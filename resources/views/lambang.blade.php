...
@section('content')
<div class="jumbotron jumbotron-fluid banner" style="background-image: url({{ asset('img/karya_new_watermark/umum_signature.png')}})">
</div>
    ...
    <div class="container">
        ...
        <div class="row py-5">
            <div class="col-12 text-center pb-4">
                <img src="{{ asset('img/lambang.png') }}" alt="" class="img-fluid w-25">
            </div>
            <div class="col-12 text-justify">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <img src="{{ asset('img/sekilas-depok/1.svg') }}" alt="" class="img-fluid">
                    </div>
                    <div class="col-9">
                        <p class="lead">
                ...
                <div class="row">
                    <div class="col-3">
                        <img src="{{ asset('img/sekilas-depok/2.svg') }}" alt="" class="img-fluid">
                    </div>
                    <div class="col-9">
                        <p class="lead">
                ...
                <div class="row">
                    <div class="col-3">
                        <img src="{{ asset('img/sekilas-depok/3.svg') }}" alt="" class="img-fluid">
                    </div>
                    <div class="col-9">
                        <p class="lead">
