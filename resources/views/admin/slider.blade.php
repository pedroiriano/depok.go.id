                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-success btn-sm btn-icon-split mb-1"
                                    onclick="loadUbahModal('{{ $slider->nama }}', '{{ $slider->deskripsi }}', '{{ $slider->status }}', '{{ $slider->imageName }}', '{{ $slider->id }}')">
                                    <span class="icon">
                                        <i class="fas fa-edit"></i>
                                    </span>
                                    <span class="text">Ubah</span>
                                </button>
                                <form action="{{ route('admin.hapusSlider', $slider->id) }}" method="POST" class="form-inline">
                                    @method('DELETE')
                                    @csrf
                                    <button class="btn btn-danger btn-icon-split btn-sm" data-id="{{ $slider->id }}"
                                        id="deleteSlider">
                                        <span class="icon">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('admin.tambahSlider') }}" enctype="multipart/form-data">
                    @csrf
