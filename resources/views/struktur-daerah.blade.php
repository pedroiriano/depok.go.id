...
@section('content')
<div class="jumbotron jumbotron-fluid banner" style="background-image: url({{ asset('img/karya_new_watermark/Umum_141.png') }})">
</div>
    ...
    <div class="container">
        ...
        <div class="row pb-5">
            <div class="col-12">
                ...
                <img src="{{ asset('img/STRUKTUR-OPD2.jpg') }}" alt="" class="img-fluid mb-4">
                <p class="lead">
