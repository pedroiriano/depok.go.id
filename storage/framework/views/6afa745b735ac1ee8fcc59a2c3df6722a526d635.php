...
<div class="container text-center">
     <div class="btn-group btn-group-lg flex-wrap" role="group" aria-label="#" style="top:-27px">
        ...
        <input type="button" onclick="window.location.href='<?php echo e(route('kelurahan')); ?>'" value="Kelurahan" class="btn btn-primary"/>
        </div>
</div>
...
<?php echo $__env->make('includes.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\depok.go.id\resources\views/kelurahan.blade.php ENDPATH**/ ?>