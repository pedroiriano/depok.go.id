...
<nav class="shadow navbar navbar-expand-lg navbar-light bg-white flex-column flex-md-row sticky-top ">
    <div class="container">
        <a class="navbar-brand py-2" href="<?php echo e(route('beranda')); ?>">
                <img src="<?php echo e(asset('img/asset-2.png')); ?>" alt="" height="40" class="d-inline-block align-top" id="brand">
        </a>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('lambangIdentitas')); ?>">Lambang Identitas</a>
                        <a class="dropdown-item" href="<?php echo e(route('ikonKota')); ?>">Ikon Kota</a>
                        <a class="dropdown-item" href="<?php echo e(route('seniBudaya')); ?>">Seni Budaya</a>
                        
                        <a class="dropdown-item" href="<?php echo e(route('penghargaan')); ?>">Penghargaan</a>
                        <a class="dropdown-item" href="<?php echo e(route('demografi')); ?>">Demografi</a>
                        <a class="dropdown-item" href="<?php echo e(route('geografi')); ?>">Geografi</a>
                        </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<?php echo e(route('visiMisi')); ?>">Visi & Misi Kota</a>
                        <a class="dropdown-item" href="<?php echo e(route('pimpinanDaerah')); ?>">Pimpinan Daerah</a>
                        <a class="dropdown-item" href="<?php echo e(route('strukturDaerah')); ?>">Struktur Daerah</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="<?php echo e(route('dinas')); ?>">Dinas</a>
                        <a class="dropdown-item" href="<?php echo e(route('sekda')); ?>">Sekretariat Daerah</a>
                        <a class="dropdown-item" href="<?php echo e(route('kecamatan')); ?>">Kecamatan</a>
                        <a class="dropdown-item" href="<?php echo e(route('kelurahan')); ?>">Kelurahan</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<?php echo e(route('infografis')); ?>">Infografis</a>
...
</nav><?php /**PATH /Users/macbook/Sites/frontend/resources/views/includes/navbar.blade.php ENDPATH**/ ?>