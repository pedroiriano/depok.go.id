...
<div class="jumbotron jumbotron-fluid banner" style="background-image: url(<?php echo e(asset('img/karya_new_watermark/Umum_Designer_Ngaret.png')); ?>)">
</div>
<div class="container-fluid">
    <div class="container">
        <h1 class="display-3 pt-5">Visi dan Misi</h1>
        <h6 class="h6 pb-5">Periode 2016-2021</h6>
        <div class="row pb-5">
           <div class="col-12">
...
<?php echo $__env->make('includes.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\depok.go.id\resources\views/visi-misi.blade.php ENDPATH**/ ?>