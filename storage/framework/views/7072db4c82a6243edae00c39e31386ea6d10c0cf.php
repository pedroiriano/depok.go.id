            ...
            <div class="col-12 col-md-10">
                <div class="row justify-content-center">
                    ...
                    <div class="col-4 col-md-2 my-3">
                        <a href="#" id="btnModal" data-toggle="modal" data-target="#modalLayanan-<?php echo e($category->id); ?>" data-content="#" style="color:#1d1d1d;text-decoration:none">
...
<?php echo $__env->make('includes.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Sites/depok/resources/views/layanan.blade.php ENDPATH**/ ?>