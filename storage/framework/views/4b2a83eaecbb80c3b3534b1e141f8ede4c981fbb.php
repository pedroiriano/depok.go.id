...
<div class="jumbotron jumbotron-fluid banner" style="background-image: url(<?php echo e(asset('img/sekilas-depok/1.jpg')); ?>)">
</div>
<div class="container-fluid">
    <div class="container">
        <h1 class="display-3 py-5">Sejarah</h1>
        
        <div class="row py-4 text-justify">
            <p class="lead">Depok berawal dari sebuah Kecamatan yang berada di lingkungan Kewedanaan (Pembantu Bupati) wilayah Parung Kabupaten Bogor, kemudian pada tahun 1976 perumahan mulai dibangun baik oleh Perum Perumnas maupun pengembang yang kemudian diikuti dengan dibangunnya kampus Universitas Indonesia (UI), serta meningkatnya perdagangan dan Jasa yang semakin pesat sehingga diperlukan kecepatan pelayanan.</p>
...
<p class="lead">Kota Depok selain merupakan Pusat Pemerintahan yang berbatasan langsung dengan Wilayah Daerah Khusus Ibu Kota Jakarta juga merupakan wilayah penyangga Ibu Kota Negara yang diarahkan untuk kota pemukiman , Kota Pendidikan, Pusat pelayanan perdagangan dan jasa, Kota pariwisata dan sebagai kota resapan air.</p>
             <div class="col-12">
                <h1 class="display-5 py-5">Kepemimpinan 1982 -2019</h1>
            </div>
            <div class="col-12 py-5">
            <img src="<?php echo e(asset('images/pempindepok.svg')); ?>" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</div>
...
editor.setContents(<?php echo $sejarah->content; ?>);
htmlContent.innerHTML = editor.root.innerHTML;
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('includes.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\depok.go.id\resources\views/sejarah.blade.php ENDPATH**/ ?>