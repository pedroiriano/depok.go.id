...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Agenda -->
    <li class="nav-item <?php echo e(Request::is('admin-agenda') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route('admin.agenda')); ?>">
            <i class="fas fa-calendar-alt"></i>
            <span>Agenda</span></a>
    </li>
    <!-- Nav Item - Layanan DSW -->
    <li class="nav-item <?php echo e(Request::is('admin-layanan-dsw') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route('admin.layanan')); ?>">
    ...
    <li class="nav-item <?php echo e(Request::is('admin-slider') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route('admin.slider')); ?>">
    ...
    <!-- Nav Item - Slider -->
    <li class="nav-item <?php echo e(Request::is('admin-header') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route('admin.header')); ?>">
    ...
    <li class="nav-item">
        ...
        <div id="collapseSekilasDepok" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.sejarah')); ?>">Sejarah</a>
                <a class="collapse-item" href="#">Lambang Identitas</a>
                <a class="collapse-item" href="<?php echo e(route('admin.ikon')); ?>">Ikon Kota</a>
...
<!-- End of Sidebar --><?php /**PATH /var/www/html/frontend/resources/views/includes/sidebar.blade.php ENDPATH**/ ?>