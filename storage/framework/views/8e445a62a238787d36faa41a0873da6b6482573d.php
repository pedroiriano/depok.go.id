...
<div class="jumbotron jumbotron-fluid banner" style="background-image: url(<?php echo e(asset('img/karya_new_watermark/umum_signature.png')); ?>)">
</div>
<div class="container-fluid">
    <div class="container">
        <h1 class="display-3 py-4">Lambang dan Identitas</h1>
        <div class="row py-5">
            <div class="col-12 text-center pb-4">
                <img src="<?php echo e(asset('img/lambang.png')); ?>" alt="" class="img-fluid w-25">
            </div>
            <div class="col-12 text-justify">
                <h5 class="h5">Bagian A</h5>
                <div class="row">
                    <div class="col-12">
                    </div>
                    <div class="col-3">
                        <img src="<?php echo e(asset('img/sekilas-depok/1.svg')); ?>" alt="" class="img-fluid">
                    </div>
                    <div class="col-9">
                        <p class="lead">
                ...
                <div class="row">
                    <div class="col-3">
                        <img src="<?php echo e(asset('img/sekilas-depok/2.svg')); ?>" alt="" class="img-fluid">
                    </div>
                    <div class="col-9">
                        <p class="lead">
                ...
                <div class="row">
                    <div class="col-3">
                        <img src="<?php echo e(asset('img/sekilas-depok/3.svg')); ?>" alt="" class="img-fluid">
                    </div>
                    <div class="col-9">
                        <p class="lead">
...
<?php echo $__env->make('includes.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\depok.go.id\resources\views/lambang.blade.php ENDPATH**/ ?>