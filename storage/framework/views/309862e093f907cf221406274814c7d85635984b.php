...
<?php echo $__env->make('includes.carousel-video', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<!-- <div class="container-fluid"
    style="background-image:url('<?php echo e(asset('img/depok.jpeg')); ?>'); min-height: 80vh;background-position: center;background-repeat: no-repeat;background-size: cover;box-shadow: inset 0 0 0 1000px rgba(0,0,0,.2);">
    <div class="container">
        <div class="row py-5 justify-content-center text-center">
            <div class="col-10">
                <img src="<?php echo e(asset('img/lambang.png')); ?>" alt="" class="logo-pemkot" style="padding-top: 100px;">
    ...
    <div class="row">
        <div class="col-12 col-md-5">
            <div class="card text-white" style="border: 1px solid #3598db; background-color: #3598db">
                <img src="<?php echo e(asset('images/2.png')); ?>" class="card-img-top">
                <div class="card-body text-center p-2 rounded-bottom" style="background-color: #26498d">
                    <h5 class="h5 font-weight-bold"><?php echo e($tanggal); ?></h5>
                    <p class="card-text"><?php echo $__env->make('includes.waktu-shalat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></p>
                </div>
            </div>
        </div>
...
<div class="container-fluid" style="background-color: #ecf0f1">
    <div class="row justify-content-center py-5">
        ...
        <?php if($category->pos > 6): ?>
            <div class="col-4 col-md-2 my-3 d-none d-sm-block">
        <?php else: ?>
            <div class="col-4 col-md-2 my-3">
        <?php endif; ?>
            <a href="#" id="btnModal-<?php echo e($category->id); ?>" class="btnModal" data-toggle="modal" data-target="#modalLayanan-<?php echo e($category->id); ?>" data-content="#" style="color:#1d1d1d;text-decoration:none; ">
        ...
        <a href=" <?php echo e(route('layanan')); ?> " class="btn btn-outline-primary mt-5">Layanan Lainnya</a>
        </div>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <div class="row pt-5">
        <div class="col-12 col-md-5">
            ...
            <div class="row <?php if($index == 0): ?> <?php echo e('pt-5'); ?> <?php endif; ?>">
                <div class="col-4">
                    <img src="<?php echo e(asset('uploads/slider/'.$slider->imageName)); ?>" alt="" class="img-fluid rounded">
                </div>
                <div class="col">
                        <span class="lead text-muted"><i class="fas fa-calendar-alt"></i>&nbsp;<?php echo e($slider->created_at->format('d/m/Y')); ?></span>
                    <p class="lead"><?php echo e($slider->deskripsi); ?></p>
                </div>
            </div>
            <hr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-12 col-md">
            ...
            <div class="agenda f-14" style="height:600px;overflow: scroll">
                <?php $__currentLoopData = $agendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($agenda->tanggal >= Carbon\Carbon::today()): ?>
                        <div class="row py-2">
                            <div class="col-3 pt-1">
                                <?php echo e(date('d-M-y',strtotime($agenda->tanggal))); ?>

                            </div>
                            <div class="col-9">
                                <div class="card w-100">
                                    <div class="card-body" style="padding:.75rem">
                                        <h5 class="card-title text-success"><?php echo e($agenda->nama); ?></h5>
                                        <div class="row card-text text-muted">
                                            <div class="col-1">
                                                <i class="fas fa-map-marker-alt"></i>
                                            </div>
                                            <div class="col">
                                                <p><?php echo e($agenda->tempat); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <a href="<?php echo e(route('agenda')); ?>" class="d-block d-sm-none">Agenda Lainnya <i class="fas fa-arrow-right"></i></a>
        </div>
    </div>
    <div class="d-none d-md-block">
        <div class="row pb-5">
            ...
            <div class="col">
                <a href="<?php echo e(route('agenda')); ?>" target="_blank">Agenda Lainnya <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-5" style="background-color: #ecf0f1">
    <div class="row">
        ...
        <div class="col-12 col-md col-lg-3">
            ...
            <?php $__currentLoopData = $infografis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a style="cursor: pointer">
                <img src="<?php echo e(asset('uploads/infografis/'.$info->imageName)); ?>" alt="" class="img-fluid pb-3" data-toggle="modal" data-target="#modal-infografis-<?php echo e($info->id); ?>">
                </a>
                <?php echo $__env->make('includes.modal-infografis', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('infografis')); ?>">Infografis lainnya<i class="fas fa-arrow-right"></i></a>
        </div>
...
<?php echo $__env->make('includes.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\depok.go.id\resources\views/beranda-new.blade.php ENDPATH**/ ?>