...
<div class="jumbotron jumbotron-fluid banner" style="background-image: url(<?php echo e(asset('img/karya_new_watermark/Umum_141.png')); ?>)">
</div>
<div class="container-fluid">
    <div class="container">
        <h1 class="display-3 py-5">Struktur Daerah</h1>
        <div class="row pb-5">
            <div class="col-12">
                <p class="lead mb-4">
                ...
                <img src="<?php echo e(asset('img/STRUKTUR-OPD2.jpg')); ?>" alt="" class="img-fluid mb-4">
                <p class="lead">
...
<?php echo $__env->make('includes.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\depok.go.id\resources\views/struktur-daerah.blade.php ENDPATH**/ ?>