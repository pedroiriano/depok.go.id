...
<div class="jumbotron jumbotron-fluid banner" style="background-image: url(<?php echo e(asset('img/karya_new_watermark/Umum_Keluarga_Khodok.png')); ?>)">
</div>
<div class="container-fluid">
    <div class="container">
        <h1 class="display-3 py-5">Ikon Kota</h1>
        <div class="row py-5 justify-content-center">
           <div class="col-6 pb-5">
              <img src="<?php echo e(asset('img/sekilas-depok/7.jpg')); ?>" alt="" class="img-fluid">
           </div>
...
<?php echo $__env->make('includes.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\depok.go.id\resources\views/ikon.blade.php ENDPATH**/ ?>